...
/**
 * Upgrade the database to version 2401.
 *
 * @since 2.4.0
 */
function genesis_upgrade_2401() {
...
function genesis_upgrade() {
	...
	// UPDATE DB TO VERSION 2401.
	if ( genesis_get_option( 'db_version', null, false ) < '2401' )
		genesis_upgrade_2401();
