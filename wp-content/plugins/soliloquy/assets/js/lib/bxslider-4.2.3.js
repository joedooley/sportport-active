/***
 * soliloquy v4.2.3 - Fully loaded, responsive content slider
 * http://soliloquy.com
 *
...
;(function($){
	...
	$.fn.soliloquy = function(options){
		...
		var setup = function(){
			...
			// store a namespace reference to .soliloquy-viewport
		...
		var populatePager = function(){
			...
			for(var i=0; i < pagerQty; i++){
				...
				pagerHtml += '<div class="soliloquy-pager-item"><a href="" data-slide-index="' + i + '" class="soliloquy-pager-link">' + linkContent + '</a></div>';
			}
		...
		var appendControls = function(){
			slider.controls.next = $('<a class="soliloquy-next" href="">' + slider.settings.nextText + '</a>');
			slider.controls.prev = $('<a class="soliloquy-prev" href="">' + slider.settings.prevText + '</a>');
		...
		var appendControlsAuto = function(){
			slider.controls.start = $('<div class="soliloquy-controls-auto-item"><a class="soliloquy-start" href="">' + slider.settings.startText + '</a></div>');
			slider.controls.stop = $('<div class="soliloquy-controls-auto-item"><a class="soliloquy-stop" href="">' + slider.settings.stopText + '</a></div>');
			// add the controls to the DOM
