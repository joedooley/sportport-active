...
class WC_Intuit_QBMS_API_Response implements SV_WC_Payment_Gateway_API_Response {
	...
	public function get_connection_status_message() {
		...
		switch ( $this->get_connection_status_code() ) {
			case 0:    return __( 'Authentication successful', 'woocommerce-gateway-intuit-qbms' );
			case 2000: return __( 'Application agent not found - the ticket provided is invalid or cancelled', 'woocommerce-gateway-intuit-qbms' );
			case 2010: return __( 'Unauthorized', 'woocommerce-gateway-intuit-qbms' );
			case 2020: return __( 'Session Authentication required', 'woocommerce-gateway-intuit-qbms' );
			case 2040: return __( 'Internal error', 'woocommerce-gateway-intuit-qbms' );

			default: return __( 'Unknown error', 'woocommerce-gateway-intuit-qbms' );
		}
	}
