 ...
 * @since 1.0
 */
class WC_Intuit_QBMS_API_Wallet_Query_Response extends WC_Intuit_QBMS_API_Response implements SV_WC_Payment_Gateway_API_Get_Tokenized_Payment_Methods_Response {
	 ...
	 *
	 * @since 1.0
	 * @see SV_WC_API_Get_Tokenized_Payment_Methods_Response::get_payment_tokens()
