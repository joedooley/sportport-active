  ...
  jQuery(document).ready(function($) {
    ...
    return window.SV_WC_Payment_Form_Handler = (function() {
      function SV_WC_Payment_Form_Handler(args) {
        ...
        this.params = window[this.plugin_id + "_params"];
        if (this.type === 'echeck') {
      ...
      SV_WC_Payment_Form_Handler.prototype.validate_payment_data = function() {
        ...
        tokenized_payment_method_selected = this.payment_fields.find('.js-sv-wc-payment-gateway-payment-token:checked').val();
