 ...
 */
		...
		$chart1_title= $chart1_assets[0]['chart-title'];
		$chart1_img= $chart1_assets[0]['chart-image'];
		$chart1_img_position=$chart1_assets[0]['chart-position'];
		$chart1_content=$chart1_assets[0]['chart-content'];
		$chart1_table=$chart1_assets[0]['chart-table'];
		...
		$chart2_title= $chart2_assets[0]['chart-title-1'];
		$chart2_img= $chart2_assets[0]['chart-image-1'];
		$chart2_img_position=$chart2_assets[0]['chart-position-1'];
		$chart2_content=$chart2_assets[0]['chart-content-1'];
		$chart2_table=$chart2_assets[0]['chart-table-1'];
       ...
       <div class="title-wrap"> <h2>Chart 1</h2></div>
        ...
        <div class="field-description"><?php _e( 'Add/Edit chart image below', $this->plugin_name); ?></div>
         ...
         <input type="hidden" name="chart-image-1" id="chart-image-1" value="<?php echo esc_attr($chart1_img); ?>" /></div>
         <?php 
		  $img=wp_get_attachment_image_src($chart1_img,'thumbnail'); ?>
          <div id="field-image"><img src="<?php echo !empty($img[0]) ? $img[0] :  plugins_url( 'images/chart-img-placeholder.jpg', dirname(__FILE__) ); ?>" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>"  id="meta_img_1" /></div>
       ...
       ?>
		   ...
		   <div class="field-title"><h4><?php _e( 'Chart Table', $this->plugin_name); ?></h4></div> 
            <div class="field-description"><?php _e( 'Add/Edit chart below', $this->plugin_name); ?></div>
		       <div class="field-item">
                  <textarea  id="chart-table-1" name="chart-table-1"><?php echo esc_attr( $chart1_table ) ; ?></textarea></div>
            </div>
       ...
       <div class="title-wrap"> <h2>Chart 2</h2></div>
        ...
        <div class="field-description"><?php _e( 'Add/Edit chart image below', $this->plugin_name); ?></div>
 		 <div class="field-item"> 
         <input type="hidden" name="chart-image-2" id="chart-image-2" value="<?php echo esc_attr($chart2_img); ?>" /></div>
         <?php 
		  $img=wp_get_attachment_image_src($chart2_img,'thumbnail'); ?>
          <div id="field-image"><img src="<?php echo !empty($img[0]) ? $img[0] : plugins_url( 'images/chart-img-placeholder.jpg', dirname(__FILE__) ); ?>" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>" id="meta_img_2" /></div>
       ...
       ?>
		   ...
		   <div class="field-title"><h4><?php _e( 'Chart Table', $this->plugin_name); ?></h4></div> 
            <div class="field-description"><?php _e( 'Add/Edit chart below', $this->plugin_name); ?></div>
		       <div class="field-item">
                  <textarea  id="chart-table-2" name="chart-table-2"><?php echo esc_attr( $chart2_table ) ; ?></textarea></div>
            </div>
