...
if ( ! defined( 'CMB_URL' ) )
	define( 'CMB_URL', plugin_dir_path( __FILE__ ) );
...
function CMB_Chart_cmb_init() {
	...
	$meta_boxes = apply_filters( 'CMB_Chart_Meta_Boxes', array() );

	if ( ! empty( $meta_boxes ) )
		foreach ( $meta_boxes as $meta_box )
			new CMB_Chart_Meta_Box( $meta_box );

}
add_action( 'init', 'CMB_Chart_cmb_init', 50 );
