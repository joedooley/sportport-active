 ...
 * @abstract
 */
abstract class CMB_Chart_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<?php if ( $this->args['repeatable'] ) : ?>
				<button class="cmb-delete-field" title="Remove field"><span class="cmb-delete-field-icon">&times;</span> <?php _e('Remove Group','productsize-chart-for-woocommerce'); ?></button>
			<?php endif; ?>
			...
			<button class="button repeat-field"><?php esc_html_e( 'Add New', 'productsize-chart-for-woocommerce' ); ?></button>
 ...
 * @extends CMB_Field
 */
class CMB_Text_Field extends CMB_Chart_Field {
 ...
 */
class CMB_File_Field extends CMB_Chart_Field {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'cmb-file-upload',  plugin_dir_url( __FILE__ ) . 'js/file-upload.js', array( 'jquery', 'cmb-scripts' ) );
	...
	public function html() {
		...
		<div class="cmb-file-wrap" <?php echo 'data-type="' . esc_attr( $data_type ) . '"'; ?>>
			...
			<button class="button cmb-file-upload <?php echo esc_attr( $this->get_value() ) ? 'hidden' : '' ?>">
				<?php esc_html_e( 'Add File', 'productsize-chart-for-woocommerce' ); ?>
			</button>
			...
			<button class="cmb-remove-file button <?php echo $this->get_value() ? '' : 'hidden'; ?>">
				<?php esc_html_e( 'Remove', 'productsize-chart-for-woocommerce' ); ?>
			</button>
	...
	public function html() {
		...
		<div class="cmb-file-wrap" style="<?php echo esc_attr( $styles ); ?>" data-type="<?php echo esc_attr( $data_type ); ?>">
			...
			<button class="button cmb-file-upload <?php echo esc_attr( $this->get_value() ) ? 'hidden' : '' ?>" data-nonce="<?php echo wp_create_nonce( 'cmb-file-upload-nonce' ); ?>">
				<?php esc_html_e( 'Add Image', 'productsize-chart-for-woocommerce' ); ?>
			</button>
 ...
 *
 */
class CMB_URL_Field extends CMB_Chart_Field {
 ...
 *
 */
class CMB_Date_Field extends CMB_Chart_Field {

	public function enqueue_scripts() {

		parent::enqueue_scripts();

		wp_enqueue_style( 'cmb-jquery-ui',  plugin_dir_url( __FILE__ ) . 'css/vendor/jquery-ui/jquery-ui.css', '1.10.3' );

		wp_enqueue_script( 'cmb-datetime',  plugin_dir_url( __FILE__ ) . 'js/field.datetime.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'cmb-scripts' ) );
	}
...
class CMB_Time_Field extends CMB_Chart_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'cmb-timepicker',  plugin_dir_url( __FILE__ ) . 'js/jquery.timePicker.min.js', array( 'jquery', 'cmb-scripts' ) );
		wp_enqueue_script( 'cmb-datetime',  plugin_dir_url( __FILE__ ) . 'js/field.datetime.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-datepicker', 'cmb-scripts' ) );
	}
 ...
 *
 */
class CMB_Date_Timestamp_Field extends CMB_Chart_Field {
 ...
 *
 */
class CMB_Datetime_Timestamp_Field extends CMB_Chart_Field {
 ...
 */
class CMB_Textarea_Field extends CMB_Chart_Field {
 ...
 *
 */
class CMB_Color_Picker extends CMB_Chart_Field {

	public function enqueue_scripts() {

		parent::enqueue_scripts();

		wp_enqueue_script( 'cmb-colorpicker',  plugin_dir_url( __FILE__ ) . 'js/field.colorpicker.js', array( 'jquery', 'wp-color-picker', 'cmb-scripts' ) );
 ...
 */
class CMB_Radio_Field extends CMB_Chart_Field {
 ...
 *
 */
class CMB_Checkbox extends CMB_Chart_Field {
 ...
 *
 */
class CMB_Title extends CMB_Chart_Field {
 ...
 *
 */
class CMB_wysiwyg extends CMB_Chart_Field {

	function enqueue_scripts() {

		parent::enqueue_scripts();

		wp_enqueue_script( 'cmb-wysiwyg',  plugin_dir_url( __FILE__ ) . 'js/field-wysiwyg.js', array( 'jquery', 'cmb-scripts' ) );
	}
 ...
 */
class CMB_Select extends CMB_Chart_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', plugin_dir_url( __FILE__ ) . 'js/vendor/select2/select2.js', array( 'jquery' ) );
		wp_enqueue_script( 'field-select',plugin_dir_url( __FILE__ ) . 'js/field.select.js', array( 'jquery', 'select2', 'cmb-scripts' ) );
	}
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'select2', plugin_dir_url( __FILE__ ) . 'js/vendor/select2/select2.css' );
	}
	...
	public function output_field() {
		...
		>
			...
			<?php if ( ! empty( $this->args['allow_none'] ) ) : ?>
				<option value=""><?php echo esc_html_x( 'None', 'select field', 'productsize-chart-for-woocommerce' ) ?></option>
			<?php endif; ?>
	...
	public function output_script() {
		...
		<script type="text/javascript">
			...
			(function($) {
				...
				options.placeholder = <?php echo json_encode( __( 'Type to search', 'productsize-chart-for-woocommerce' ) ) ?>;
 ...
 */
class CMB_Group_Field extends CMB_Chart_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			$this->value = ''; ?>
				...
				<button class="button repeat-field"><?php esc_html_e( 'Add New Group', 'productsize-chart-for-woocommerce' ); ?></button>
	...
	public function html() {
		...
		<?php CMB_Chart_Meta_Box::layout_fields( $fields ); ?>
	...
	public function add_field( CMB_Chart_Field $field ) {
		$field->parent = $this;
