...
class wcva_swatch_form_fields {
	  ...
	  * since 1.0.0
	  */
     public function wcva_load_colored_select($product,$name,$options,$_coloredvariables,$newvalues,$selected_value) {  
