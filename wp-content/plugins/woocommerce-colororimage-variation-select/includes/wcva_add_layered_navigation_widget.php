	...
	public function wcva_load_each_swatch_html($count,$option_is_set,$link,$term,$display_shape) {
		...
		if (isset($swatchtype)) {
				switch ($swatchtype) {
             	    case 'Color':
             		    ?>
                        <a title="<?php echo esc_html( $term->name ); ?>" <?php echo ( $count > 0 || $option_is_set ) ? 'href="' . esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) . '"' : ''; ?> class="wcvaswatchinput"  style="width:<?php echo $imagewidth; ?>px; height:<?php echo $imageheight; ?>px;">
             	    ...
             	    case 'Image':
             		    ?>
                        <a title="<?php echo esc_html( $term->name ); ?>" <?php echo ( $count > 0 || $option_is_set ) ? 'href="' . esc_url( apply_filters( 'woocommerce_layered_nav_link', $link ) ) . '"' : ''; ?> class="wcvaswatchinput">
