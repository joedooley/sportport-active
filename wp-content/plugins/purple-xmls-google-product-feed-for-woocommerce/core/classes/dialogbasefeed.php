...
class PBaseFeedDialog {
  ...
  function attributeMappings() {
		...
		*/
		$output = '				
				<p><a target="blank" title="Generate Merchant Feed" href="http://www.exportfeed.com/documentation/generate-google-merchant-feed-woocommerce/">Generate your first feed</a> | 
